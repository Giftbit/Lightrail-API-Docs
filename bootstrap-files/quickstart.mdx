...
<Card title="Style Your Docs" icon="paintbrush" href="/bootstrap-files/essentials/settings">
...
<Card
  ...
  icon="chart-mixed"
  href="https://www.mintlify.com/docs/integrations/analytics/overview"
>
...
<Card
  ...
  icon="browser"
  href="https://www.mintlify.com/docs/customize/custom-domain"
>
